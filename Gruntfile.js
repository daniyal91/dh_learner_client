...
module.exports = function (grunt) {
  ...
  grunt.registerTask('release',['jshint','clean:before','less','dom_munger','ngtemplates','cssmin','concat','ngAnnotate','uglify','copy:main','copy:'+target,'htmlmin','imagemin','clean:after']);
